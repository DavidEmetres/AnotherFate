...
bool Egypt::init()
{
	...
	vasijaPequena1 = new Item(2, 15727, 90);
	...
	vasijaPequena2 = new Item(2, 16127, 90);
	...
	vasijaPequena3 = new Item(2, 20807, 90);
	...
	vasijaPequena4 = new Item(2, 16942, 1315);
	...
	vasijaPequena5 = new Item(2, 19078, 1498);
	...
	vasijaPequena6 = new Item(2, 20622, 844);
	...
	vasijaGrande1 = new Item(3, 18915 + 3520, 90);
	...
	vasijaGrande2 = new Item(3, 21813, 90);
	...
	case 10:														//ENEMY
		...
		else if (enemysVector.at(contactEnemy->getTag() - 1000)->facingRight && Iniko->facingRight && !enemysVector.at(contactEnemy->getTag() - 1000)->alertedEnemy && Iniko->stealth)
		{
			...
			else if (key == 'Q' && !Iniko->hide)
			{
				...
				//enemysVector.at(contactEnemy->getTag() - 1000)->enemyArt->runAction(Sequence::create(DelayTime::create(2.0f), CC_CALLBACK_0(Egypt::enemyDeath, this), NULL));
				//this->runAction(Sequence::create(DelayTime::create(2.0f), CC_CALLBACK_0(Egypt::enemyDeath, this, contactEnemy->getTag() - 1000), NULL));
				moveCam = true;
				...
				Iniko->characterIdleRight->runAction(Sequence::create(DelayTime::create(1.82), CallFunc::create(CC_CALLBACK_0(Egypt::inikoStopsKill, this)), NULL));
			}
		}
...
void Egypt::enemyDeath(int tg)
{
	enemysVector.at(tg)->die = true;
}

void Egypt::inikoStopsKill()
{
	moveCam = false;
